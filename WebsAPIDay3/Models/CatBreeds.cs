...
namespace WebsAPIDay3.Models
{
    public class BreedImageList //contains a class that contains additional properites that 
        //CatBreedList does not contain
        //holds list of images even though returing one image

    //created CatByBreed Model, pasted Json, got BreedImageList and BreedImage into here
    //then deleted CatByBreed Model.
    {
        public BreedImage[] Property1 { get; set; }
        //also contains an array of CatBreeds
    }
    ...
    public class CatBreedList //1 change rootobject to CatBreedList 
    {
        public CatBreed[] Property1 { get; set; } //2 change to catbreed
    }

    public class CatBreed //3 change to catbreed //gonna go in List
    {
